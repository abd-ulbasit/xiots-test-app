...
export default function PostHero() {
    return (
        <div style={{ backgroundImage: `url("/images/postsbanner.png")` }} className="bg-cover relative bg-center text-white" >
            ...
            <div className="flex  z-10 flex-col items-center justify-center sm:p-32 p-24  gap-2">
                <h1 className="uppercase text-5xl font-bold z-10" >Posts</h1>
                <p className="z-10 sm:text-lg ">Home <AiOutlineDoubleRight className="inline"></AiOutlineDoubleRight> Post</p>
            </div>
        </div>
    )
}